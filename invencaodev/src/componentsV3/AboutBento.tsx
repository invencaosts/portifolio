      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid grid-cols-1 items-start gap-x-12 gap-y-16 lg:grid-cols-12 lg:gap-y-32">
          ...
          <div className="flex flex-col justify-between self-stretch lg:col-span-5">
            <div>
              <h2 className="font-headline text-primary mb-8 flex items-center gap-3 text-sm tracking-[0.3em] uppercase md:mb-12">
          ...
          <div className="grid grid-cols-3 gap-1 lg:col-span-7">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <span className="text-primary/60 relative z-10 font-mono text-[8px] sm:text-[10px] md:text-xs">
                  {stat.id}_{stat.label}
                </span>
                <div className="font-headline group-hover:text-primary text-foreground relative z-10 text-xl font-bold transition-colors sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl">
                  {stat.value}
                </div>
                <p className="text-foreground/50 relative z-10 font-mono text-[7px] leading-tight uppercase sm:text-[9px] md:text-[10px]">
                  {stat.sub}
                </p>
            ...
            <div className="bento-card group relative order-3 aspect-square cursor-pointer overflow-hidden lg:order-6">
              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-between p-3 sm:p-5 md:p-6 lg:p-8">
                <span className="text-primary/60 font-mono text-[8px] sm:text-[10px] md:text-xs">
                  06_IDENTIDADE
                </span>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <span className="text-primary animate-pulse font-mono text-[8px] uppercase sm:text-[10px]">
                    Scanning...
                  </span>
                </div>
          ...
          <div className="self-start lg:col-span-5">
            <div className="text-foreground/40 mb-4 font-mono text-xs tracking-widest uppercase">
