    ...
    <section id="inicio" className="relative min-h-[85vh] flex flex-col justify-start pt-24 md:pt-32 pb-16 px-6 md:px-20 lg:px-32 xl:px-40 overflow-hidden bg-background">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-8 lg:pb-12 text-left order-1">
          ...
          <h1 className="font-headline text-4xl sm:text-6xl md:text-7xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-bold tracking-tighter leading-[0.9] mb-8 text-foreground uppercase">
            GUILHERME<br />
            <span className="text-foreground/20 italic">DA_INVENÇÃO</span>
          </h1>

          <div className="font-headline text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary tracking-tight uppercase min-h-[3em] sm:min-h-[1.5em]">
            <TypeAnimation
              sequence={[
        ...
        <div className="lg:col-span-4 relative group flex justify-center lg:justify-end order-2 mt-8 lg:mt-0">
          <div className="aspect-[4/5] w-full max-w-[280px] sm:max-w-[320px] lg:max-w-[420px] bg-neutral/10 relative overflow-hidden border border-borderColor/20 rounded-2xl shadow-2xl">
            ...
            <div className="absolute bottom-4 right-4 md:bottom-6 md:right-6 font-mono text-[9px] md:text-[11px] lg:text-[10px] xl:text-[11px] font-bold text-white text-right leading-tight uppercase bg-primary px-3 py-2 md:px-4 md:py-3 lg:px-3 lg:py-2 xl:px-4 xl:py-3 rounded-md shadow-[0_10px_30px_rgba(255,49,49,0.5)] border border-white/20 z-10">
              <span className="opacity-80 block text-[7px] md:text-[9px] lg:text-[8px] xl:text-[9px] mb-1 tracking-widest bg-white/10 px-1 inline-block">LOCALIZAÇÃO_SISTEMA</span>
