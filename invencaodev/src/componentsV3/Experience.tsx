    ...
    <section id="experiencia" className="py-24 px-6 md:px-12 lg:px-24 xl:px-40 bg-neutral/5 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-[2px] bg-primary/20 shadow-[0_0_15px_rgba(255,49,49,0.2)] md:-translate-x-1/2"></div>
            ...
            {experiences.map((exp, index) => {
              ...
              return (
                <div key={index} className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-0 relative">
                  ...
                  >
                    <div className={`bg-neutral/10 p-8 border-l-2 ${isEven ? "md:border-l-0 md:border-r-2" : "md:border-l-2"
                      } border-primary hover:bg-neutral/20 transition-all duration-300 group`}>
                  ...
                  <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-4 h-4 bg-primary z-10 border-4 border-background rotate-45 shadow-[0_0_10px_#ff3131]"></div>
                  ...
                  <div className={`w-full md:w-1/2 ${isEven ? "md:pl-16 order-1 md:order-2" : "md:pr-16 md:mr-auto order-1 md:order-1 flex justify-end"
                    ...
                    <div className="w-32 h-32 bg-neutral/10 flex items-center justify-center border border-borderColor/10 group-hover:border-primary/30 transition-colors overflow-hidden p-6 rounded-sm">
                      <div className="relative w-full h-full">
                        <Image
                          src={exp.logo}
                          alt={`${exp.company} Logo`}
                          fill
                          className="object-contain opacity-40 group-hover:opacity-100 grayscale-[50%] group-hover:grayscale-0 transition-all duration-500 scale-90 group-hover:scale-100"
                        />
                      </div>
                    </div>
                  </div>
