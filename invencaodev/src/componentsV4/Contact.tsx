          ...
          <div className="bento-card group relative flex h-full flex-col p-8 md:p-12 lg:col-span-7">
            ...
            >
              <div className="space-y-8">
                ...
                <div className="group/field">
                  <label
                    ...
                    className="text-foreground/40 group-focus-within/field:text-primary-text font-mono text-[10px] tracking-[0.2em] uppercase transition-colors"
                  >
                    01. Identificação
                  </label>
                  <input
              ...
              <div className="pt-8">
                ...
                <p className="text-foreground/45 mb-4 font-mono text-[10px]">
